...
namespace PrototipoSistemaFGV.Migrations
{
    ...
    [Migration("20200707222827_Add-Base-Calculo")]
    partial class AddBaseCalculo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrototipoSistemaFGV.Authorization.BaseCalcules.BaseCalculo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("CnpjConveniado")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CodigoConveniado")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("NumeroPedidoWeb")
                        .HasColumnType("int");

                    b.Property<int>("Repasse")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PrototipoSistemaFGV.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PrototipoSistemaFGV.Authorization.Users.User", null)
                        .WithMany("Claims")
