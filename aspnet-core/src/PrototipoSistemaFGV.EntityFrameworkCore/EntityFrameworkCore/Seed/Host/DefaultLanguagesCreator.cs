...
namespace PrototipoSistemaFGV.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PrototipoSistemaFGVConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(PrototipoSistemaFGVDbContext context)
        {
            _context = context;
        }
